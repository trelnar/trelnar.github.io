...
<p>A new toolchain is a leadership problem before it is a tooling problem. I learned the tools before asking the team to. Then I ran a learning day: no product work, no clinical constraints, a made-up brief per designer, and one rule, ship a working prototype by the end of the day. Everyone did. Some of it was silly on purpose. That was the point; the fear of the tool went away in an afternoon.</p>
<p>Pattern ownership gave the learning somewhere to land. The pipeline, the tooling, and the skill library came out of designers building for themselves, not out of a mandate.</p>'''),
...
<p>Each tenet came with evidence. Screenshots taken the day before, without cherry-picking, showed headers, type, color, and illustration styles that changed from screen to screen. Screens were functional and viable and plainly not lovable. And a print-ordering link a product owner had placed in the home header had drawn almost no traffic in a year; printing wasn't in customers' top ten needs. No customer need, no reason to keep it.</p>'''),
 (video("../img/amazon/cooper-process-1.mp4","../img/amazon/cooper-process-1-poster.jpg","Cooper, part 1: the process, in my words. Sound on.",loop=False)+video("../img/amazon/cooper-launch-2.mp4","../img/amazon/cooper-launch-2-poster.jpg","Cooper, part 2: the launch video. 62 seconds, sound on.",loop=False,maxw=404)+video("../img/amazon/cooper-prototypes.mp4","../img/amazon/cooper-prototypes-poster.jpg","Cooper prototypes, built and tested with customers before the rebuild."),
...
<p class="meta">Figures from <a href="https://innovation.ebayinc.com/stories/magical-listing-tool-harnesses-the-power-of-ai-to-make-selling-on-ebay-faster-easier-and-more-accurate/" rel="noopener">eBay's launch post</a>. Named Best Overall Generative AI Solution in the <a href="https://innovation.ebayinc.com/stories/ebays-magical-listing-tool-wins-ai-breakthrough-award-for-best-overall-generative-ai-solution/" rel="noopener">AI Breakthrough Awards</a>.</p>'''),
 (slot("sprint method diagram: personas, journeys, territories"),
