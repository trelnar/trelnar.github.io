...
<p>A new toolchain is a leadership problem before it is a tooling problem. I learned the tools first, wrote the first skills myself, and only then asked the team to follow. Then I ran a learning day: no product work, no clinical constraints, a made-up brief per designer, and one rule, ship a working prototype by the end of the day. Everyone did. Some of it was silly on purpose. That was the point; the fear of the tool went away in an afternoon.</p>
